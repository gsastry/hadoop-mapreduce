/* 
 * JobQueueBalAssign implements the Bal-Assign greedy task assignment
 * algorithm by Xueyuan Su.
 * 
 * + There are three cost functions (constants) to tweak for 
 * Bal-Assign: cost_local, cost_rack, and cost_remote.
 * 
 * @author Girish Sastry
 * @author http://www.github.com/derelikt
 * @version 0.1
 * 
 */
 ...
 * by default).
 */
class JobQueueBalAssign extends TaskScheduler {
  
  private static final int MIN_CLUSTER_SIZE_FOR_PADDING = 3;
  public static final Log LOG = LogFactory.getLog(JobQueueBalAssign.class);
  ...
  public synchronized List<Task> assignTasks(TaskTracker taskTracker)
    ...
    final int costLocal = 1;
    final int costRack = 1;
    final int costRemote = 5;
